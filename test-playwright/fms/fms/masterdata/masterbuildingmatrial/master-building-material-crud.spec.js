...
const MODULE_URL = `${BASE_URL}/fms/master/building-material-type`;

// ============================================================
// HELPER: Login & Navigate to Master Building Material Page
// ============================================================
async function loginAndGoToBuildingMaterial(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToBuildingMaterial: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Building Material - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Building Material', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Building Material page loads correctly
  test('TC-01: Master Building Material page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Building Material page load test');
    await loginAndGoToBuildingMaterial(page);
    ...
    console.log('TC-01: Master Building Material page loaded successfully');
    await page.screenshot({ path: 'test-results/bm-tc01-page-load.png' });
  });

  // TC-02: Add new Master Building Material entry
  test('TC-02: Add new Master Building Material entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Building Material test');
    await loginAndGoToBuildingMaterial(page);
    ...
    await page.screenshot({ path: 'test-results/bm-tc02-add.png' });
  });

  // TC-03: Search Master Building Material
  test('TC-03: Search Master Building Material', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc03-search.png' });
  });

  // TC-04: Filter Master Building Material
  test('TC-04: Filter Master Building Material', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Building Material detail
  test('TC-05: View Master Building Material detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc05-view.png' });
  });

  // TC-06: Edit Master Building Material entry
  test('TC-06: Edit Master Building Material entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc06-edit.png' });
  });

  // TC-07: Export Master Building Material data
  test('TC-07: Export Master Building Material data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc07-export.png' });
  });

  // TC-08: Test Master Building Material pagination
  test('TC-08: Test Master Building Material pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc08-pagination.png' });
  });

  // TC-09: Verify Master Building Material status indicators
  test('TC-09: Verify Master Building Material status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc09-status.png' });
  });

  // TC-10: Delete Master Building Material entry (check delete button)
  test('TC-10: Delete Master Building Material entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bm-tc10-delete.png' });
  });
});
