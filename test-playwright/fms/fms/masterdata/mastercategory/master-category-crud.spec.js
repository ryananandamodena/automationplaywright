...
const MODULE_URL = `${BASE_URL}/fms/master/category`;

// ============================================================
// HELPER: Login & Navigate to Master Category Page
// ============================================================
async function loginAndGoToCategory(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToCategory: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Category - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Category', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Category page loads correctly
  test('TC-01: Master Category page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Category page load test');
    await loginAndGoToCategory(page);
    ...
    console.log('TC-01: Master Category page loaded successfully');
    await page.screenshot({ path: 'test-results/category-tc01-page-load.png' });
  });

  // TC-02: Add new Master Category entry
  test('TC-02: Add new Master Category entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Category test');
    await loginAndGoToCategory(page);
    ...
    await page.screenshot({ path: 'test-results/category-tc02-add.png' });
  });

  // TC-03: Search Master Category
  test('TC-03: Search Master Category', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc03-search.png' });
  });

  // TC-04: Filter Master Category
  test('TC-04: Filter Master Category', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Category detail
  test('TC-05: View Master Category detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc05-view.png' });
  });

  // TC-06: Edit Master Category entry
  test('TC-06: Edit Master Category entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc06-edit.png' });
  });

  // TC-07: Export Master Category data
  test('TC-07: Export Master Category data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc07-export.png' });
  });

  // TC-08: Test Master Category pagination
  test('TC-08: Test Master Category pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc08-pagination.png' });
  });

  // TC-09: Verify Master Category status indicators
  test('TC-09: Verify Master Category status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc09-status.png' });
  });

  // TC-10: Delete Master Category entry (check delete button)
  test('TC-10: Delete Master Category entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/category-tc10-delete.png' });
  });
});
