...
const MODULE_URL = `${BASE_URL}/fms/master/branch`;

// ============================================================
// HELPER: Login & Navigate to Master Branch Page
// ============================================================
async function loginAndGoToBranch(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToBranch: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Branch - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Branch', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Branch page loads correctly
  test('TC-01: Master Branch page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Branch page load test');
    await loginAndGoToBranch(page);
    ...
    console.log('TC-01: Master Branch page loaded successfully');
    await page.screenshot({ path: 'test-results/branch-tc01-page-load.png' });
  });

  // TC-02: Add new Master Branch entry
  test('TC-02: Add new Master Branch entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Branch test');
    await loginAndGoToBranch(page);
    ...
    await page.screenshot({ path: 'test-results/branch-tc02-add.png' });
  });

  // TC-03: Search Master Branch
  test('TC-03: Search Master Branch', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc03-search.png' });
  });

  // TC-04: Filter Master Branch
  test('TC-04: Filter Master Branch', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Branch detail
  test('TC-05: View Master Branch detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc05-view.png' });
  });

  // TC-06: Edit Master Branch entry
  test('TC-06: Edit Master Branch entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc06-edit.png' });
  });

  // TC-07: Export Master Branch data
  test('TC-07: Export Master Branch data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc07-export.png' });
  });

  // TC-08: Test Master Branch pagination
  test('TC-08: Test Master Branch pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc08-pagination.png' });
  });

  // TC-09: Verify Master Branch status indicators
  test('TC-09: Verify Master Branch status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc09-status.png' });
  });

  // TC-10: Delete Master Branch entry (check delete button)
  test('TC-10: Delete Master Branch entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/branch-tc10-delete.png' });
  });
});
