...
// ============================================================
// HELPER: Login & Navigate to Master Building Component Page
// ============================================================
...
// ============================================================
// TEST SUITE: Master Building Component - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Building Component', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Building Component page loads correctly
  test('TC-01: Master Building Component page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Building Component page load test');
    ...
    console.log('TC-01: Master Building Component page loaded successfully');
    await page.screenshot({ path: 'test-results/bc-tc01-page-load.png' });
  });

  // TC-02: Add new Master Building Component entry
  test('TC-02: Add new Master Building Component entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Building Component test');
    await loginAndGoToBuildingComponent(page);
    ...
    await page.screenshot({ path: 'test-results/bc-tc02-add.png' });
  });

  // TC-03: Search Master Building Component
  test('TC-03: Search Master Building Component', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc03-search.png' });
  });

  // TC-04: Filter Master Building Component
  test('TC-04: Filter Master Building Component', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Building Component detail
  test('TC-05: View Master Building Component detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc05-view.png' });
  });

  // TC-06: Edit Master Building Component entry
  test('TC-06: Edit Master Building Component entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc06-edit.png' });
  });

  // TC-07: Export Master Building Component data
  test('TC-07: Export Master Building Component data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc07-export.png' });
  });

  // TC-08: Test Master Building Component pagination
  test('TC-08: Test Master Building Component pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc08-pagination.png' });
  });

  // TC-09: Verify Master Building Component status indicators
  test('TC-09: Verify Master Building Component status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc09-status.png' });
  });

  // TC-10: Delete Master Building Component entry (check delete button)
  test('TC-10: Delete Master Building Component entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/bc-tc10-delete.png' });
  });
});
