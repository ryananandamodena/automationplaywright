...
const MODULE_URL = `${BASE_URL}/fms/master/vehicle-model`;

// ============================================================
// HELPER: Login & Navigate to Master Vehicle Model Page
// ============================================================
async function loginAndGoToVehicleModel(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToVehicleModel: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Vehicle Model - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Vehicle Model', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Vehicle Model page loads correctly
  test('TC-01: Master Vehicle Model page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Vehicle Model page load test');
    await loginAndGoToVehicleModel(page);
    ...
    console.log('TC-01: Master Vehicle Model page loaded successfully');
    await page.screenshot({ path: 'test-results/vmodel-tc01-page-load.png' });
  });

  // TC-02: Add new Master Vehicle Model entry
  test('TC-02: Add new Master Vehicle Model entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Vehicle Model test');
    await loginAndGoToVehicleModel(page);
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc02-add.png' });
  });

  // TC-03: Search Master Vehicle Model
  test('TC-03: Search Master Vehicle Model', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc03-search.png' });
  });

  // TC-04: Filter Master Vehicle Model
  test('TC-04: Filter Master Vehicle Model', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Vehicle Model detail
  test('TC-05: View Master Vehicle Model detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc05-view.png' });
  });

  // TC-06: Edit Master Vehicle Model entry
  test('TC-06: Edit Master Vehicle Model entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc06-edit.png' });
  });

  // TC-07: Export Master Vehicle Model data
  test('TC-07: Export Master Vehicle Model data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc07-export.png' });
  });

  // TC-08: Test Master Vehicle Model pagination
  test('TC-08: Test Master Vehicle Model pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc08-pagination.png' });
  });

  // TC-09: Verify Master Vehicle Model status indicators
  test('TC-09: Verify Master Vehicle Model status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc09-status.png' });
  });

  // TC-10: Delete Master Vehicle Model entry (check delete button)
  test('TC-10: Delete Master Vehicle Model entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/vmodel-tc10-delete.png' });
  });
});
