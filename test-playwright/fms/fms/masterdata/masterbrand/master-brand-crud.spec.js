...
const MODULE_URL = `${BASE_URL}/fms/master/brand`;

// ============================================================
// HELPER: Login & Navigate to Master Brand Page
// ============================================================
async function loginAndGoToBrand(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToBrand: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Brand - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Brand', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Brand page loads correctly
  test('TC-01: Master Brand page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Brand page load test');
    ...
    console.log('TC-01: Master Brand page loaded successfully');
    await page.screenshot({ path: 'test-results/brand-tc01-page-load.png' });
  });

  // TC-02: Add new Master Brand entry
  test('TC-02: Add new Master Brand entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Brand test');
    await loginAndGoToBrand(page);
    ...
    await page.screenshot({ path: 'test-results/brand-tc02-add.png' });
  });

  // TC-03: Search Master Brand
  test('TC-03: Search Master Brand', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc03-search.png' });
  });

  // TC-04: Filter Master Brand
  test('TC-04: Filter Master Brand', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Brand detail
  test('TC-05: View Master Brand detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc05-view.png' });
  });

  // TC-06: Edit Master Brand entry
  test('TC-06: Edit Master Brand entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc06-edit.png' });
  });

  // TC-07: Export Master Brand data
  test('TC-07: Export Master Brand data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc07-export.png' });
  });

  // TC-08: Test Master Brand pagination
  test('TC-08: Test Master Brand pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc08-pagination.png' });
  });

  // TC-09: Verify Master Brand status indicators
  test('TC-09: Verify Master Brand status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc09-status.png' });
  });

  // TC-10: Delete Master Brand entry (check delete button)
  test('TC-10: Delete Master Brand entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/brand-tc10-delete.png' });
  });
});
