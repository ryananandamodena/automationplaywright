...
const MODULE_URL = `${BASE_URL}/fms/master/uom`;

// ============================================================
// HELPER: Login & Navigate to Master UOM Page
// ============================================================
async function loginAndGoToUOM(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToUOM: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master UOM - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master UOM', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master UOM page loads correctly
  test('TC-01: Master UOM page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master UOM page load test');
    await loginAndGoToUOM(page);
    ...
    console.log('TC-01: Master UOM page loaded successfully');
    await page.screenshot({ path: 'test-results/uom-tc01-page-load.png' });
  });

  // TC-02: Add new Master UOM entry
  test('TC-02: Add new Master UOM entry', async ({ page }) => {
    console.log('TC-02: Starting add Master UOM test');
    await loginAndGoToUOM(page);
    ...
    await page.screenshot({ path: 'test-results/uom-tc02-add.png' });
  });

  // TC-03: Search Master UOM
  test('TC-03: Search Master UOM', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc03-search.png' });
  });

  // TC-04: Filter Master UOM
  test('TC-04: Filter Master UOM', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master UOM detail
  test('TC-05: View Master UOM detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc05-view.png' });
  });

  // TC-06: Edit Master UOM entry
  test('TC-06: Edit Master UOM entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc06-edit.png' });
  });

  // TC-07: Export Master UOM data
  test('TC-07: Export Master UOM data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc07-export.png' });
  });

  // TC-08: Test Master UOM pagination
  test('TC-08: Test Master UOM pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc08-pagination.png' });
  });

  // TC-09: Verify Master UOM status indicators
  test('TC-09: Verify Master UOM status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc09-status.png' });
  });

  // TC-10: Delete Master UOM entry (check delete button)
  test('TC-10: Delete Master UOM entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/uom-tc10-delete.png' });
  });
});
