...
const MODULE_URL = `${BASE_URL}/fms/master/approval`;

// ============================================================
// HELPER: Login & Navigate to Master Approval Page
// ============================================================
async function loginAndGoToApproval(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToApproval: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Approval - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Approval', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Approval page loads correctly
  test('TC-01: Master Approval page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Approval page load test');
    await loginAndGoToApproval(page);
    ...
    console.log('TC-01: Master Approval page loaded successfully');
    await page.screenshot({ path: 'test-results/approval-tc01-page-load.png' });
  });

  // TC-02: Add new Master Approval entry
  test('TC-02: Add new Master Approval entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Approval test');
    await loginAndGoToApproval(page);
    ...
    await page.screenshot({ path: 'test-results/approval-tc02-add.png' });
  });

  // TC-03: Search Master Approval
  test('TC-03: Search Master Approval', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc03-search.png' });
  });

  // TC-04: Filter Master Approval
  test('TC-04: Filter Master Approval', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Approval detail
  test('TC-05: View Master Approval detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc05-view.png' });
  });

  // TC-06: Edit Master Approval entry
  test('TC-06: Edit Master Approval entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc06-edit.png' });
  });

  // TC-07: Export Master Approval data
  test('TC-07: Export Master Approval data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc07-export.png' });
  });

  // TC-08: Test Master Approval pagination
  test('TC-08: Test Master Approval pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc08-pagination.png' });
  });

  // TC-09: Verify Master Approval status indicators
  test('TC-09: Verify Master Approval status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc09-status.png' });
  });

  // TC-10: Delete Master Approval entry (check delete button)
  test('TC-10: Delete Master Approval entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/approval-tc10-delete.png' });
  });
});
