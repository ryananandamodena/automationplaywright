...
const MODULE_URL = `${BASE_URL}/fms/master/document-type`;

// ============================================================
// HELPER: Login & Navigate to Master Document Type Page
// ============================================================
async function loginAndGoToDocument(page) {
  ...
  if (!page.url().includes('/fms/master')) {
    console.log(`loginAndGoToDocument: Still at ${page.url()}, attempting full re-login`);
...
// ============================================================
// TEST SUITE: Master Document Type - FMS Master Data
// ============================================================
test.describe('FMS Master Data - Master Document Type', () => {
  test.describe.configure({ timeout: 300000 });

  // TC-01: Verify Master Document Type page loads correctly
  test('TC-01: Master Document Type page loads correctly', async ({ page }) => {
    console.log('TC-01: Starting Master Document Type page load test');
    await loginAndGoToDocument(page);
    ...
    console.log('TC-01: Master Document Type page loaded successfully');
    await page.screenshot({ path: 'test-results/document-tc01-page-load.png' });
  });

  // TC-02: Add new Master Document Type entry
  test('TC-02: Add new Master Document Type entry', async ({ page }) => {
    console.log('TC-02: Starting add Master Document Type test');
    await loginAndGoToDocument(page);
    ...
    await page.screenshot({ path: 'test-results/document-tc02-add.png' });
  });

  // TC-03: Search Master Document Type
  test('TC-03: Search Master Document Type', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc03-search.png' });
  });

  // TC-04: Filter Master Document Type
  test('TC-04: Filter Master Document Type', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc04-filter.png' }).catch(() => {});
  });

  // TC-05: View Master Document Type detail
  test('TC-05: View Master Document Type detail', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc05-view.png' });
  });

  // TC-06: Edit Master Document Type entry
  test('TC-06: Edit Master Document Type entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc06-edit.png' });
  });

  // TC-07: Export Master Document Type data
  test('TC-07: Export Master Document Type data', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc07-export.png' });
  });

  // TC-08: Test Master Document Type pagination
  test('TC-08: Test Master Document Type pagination', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc08-pagination.png' });
  });

  // TC-09: Verify Master Document Type status indicators
  test('TC-09: Verify Master Document Type status indicators', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc09-status.png' });
  });

  // TC-10: Delete Master Document Type entry (check delete button)
  test('TC-10: Delete Master Document Type entry', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/document-tc10-delete.png' });
  });
});
