/**
 * MHC - BP GROUP CRUD TEST
 * 
 * Test CRUD operations untuk menu BP Group di Staging Data
 */
...
test.describe('MHC - BP Group CRUD Tests', () => {
  ...
  test('1. READ - Should display BP Group list', async () => {
    console.log('\n📍 TEST: READ BP Group LIST');
    ...
    console.log(`Total BP Group records: ${rowCount}`);
    
    await page.screenshot({ path: 'mhc-bp-group-crud-list.png', fullPage: true });
    console.log('✅ READ: Success');
  });

  test('2. CREATE - Should create new BP Group record', async () => {
    console.log('\n📍 TEST: CREATE BP Group');
    ...
    if (await addButton.count() > 0) {
      ...
      await page.screenshot({ path: 'mhc-bp-group-crud-create-form.png', fullPage: true });
  ...
  test('3. SEARCH - Should filter BP Group records', async () => {
    console.log('\n📍 TEST: SEARCH BP Group');
    ...
    if (await searchInput.count() > 0) {
      ...
      await page.screenshot({ path: 'mhc-bp-group-crud-search.png', fullPage: true });
  ...
  test('4. UPDATE - Should update BP Group record', async () => {
    console.log('\n📍 TEST: UPDATE BP Group');
    ...
    if (await editButton.count() > 0) {
      ...
      await page.screenshot({ path: 'mhc-bp-group-crud-update-form.png', fullPage: true });
  ...
  test('5. DELETE - Should delete BP Group record', async () => {
    console.log('\n📍 TEST: DELETE BP Group');
  ...
  test('6. VALIDATION - Should show validation errors', async () => {
    ...
    if (await addButton.count() > 0) {
      ...
      if (await submitButton.count() > 0) {
        ...
        await page.screenshot({ path: 'mhc-bp-group-crud-validation.png', fullPage: true });
